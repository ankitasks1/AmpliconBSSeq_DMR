...
NUndetermined_S0 NUndetermined_S0_L001_R1_001 NUndetermined_S0_L001_R2_001
''').strip().split('\n')
...
for listx in list_data:
    ...
    print ('SNPsplit...')
    os.system('~/tools_av/SNPsplit_v0.3.2/SNPsplit --paired --bisulfite  --snp_file /home/ankitv/ref_av/Snpfiles/SNURF_commonSNPrefalt_GRCh38_Acomb_Snpfile.txt ' + folder + '_bismark.sortedByReadname_Acomb.bam')
