                ...
                for meth in Methfile:
                   ...
                   if row[0] == meth[0]:
                      ...
                      if int(Methstart) > int(readstart) and int(Methstart) < int(readend):
                         ...
                         #print(row[4])
                         #print(Methsite + "   "+ sequence[readmethdifference])
                         #print(readmethdifference)
                         #print(sequence)
                         #print(''.join(row[4] + "\t"+ MethsiteID + "\t"+ RefsiteID + "\t"+ Refsite+ "\t" + Methsite + "\t" + sequence[readmethdifference]))
                         inforeadref = ''.join(row[4] + "\t"+ MethsiteID + "\t"+ RefsiteID + "\t"+ Refsite + "\t" + Methsite + "\t" + sequence[readmethdifference])
                         #print(inforeadref)
                 ...
                 for meth in Methfile:
                     ...
                     if row[0] == meth[0]:
                        ...
                        if int(Methstart) > int(readstart) and int(Methstart) < int(readend):
                           ...
                           inforeadalt = ''.join(row[4] + "\t"+ MethsiteID + "\t"+ AltsiteID + "\t"+ Altsite + "\t" + Methsite + "\t" + sequence[readmethdifference])
                           #print(inforeadalt)
                           file1 = open(file_name+'_'+RefsiteID+'_out.txt','a')
