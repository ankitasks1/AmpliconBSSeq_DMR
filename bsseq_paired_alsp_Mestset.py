...
for listx in list_data:
    ...
    print ('SNPsplit...')
    os.system('~/tools_av/SNPsplit_v0.3.2/SNPsplit --paired --bisulfite  --snp_file /home/ankitv/ref_av/Snpfiles/MEST_commonSNPrefalt_GRCh38_Acomb_Snpfile.txt ' + folder + '_bismark.sortedByReadname_Acomb.bam')
